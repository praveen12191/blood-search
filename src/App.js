...
function App() {
     ...
     const [ondeleted,setdeleted] = useState(false)
  ...
  return (
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/data" element={<DonorDetails details={details} setpopdata={setpopdata} setdetails={setdetails} ondeleted={ondeleted}></DonorDetails>}></Route>
            <Route path="/pin" element={<Popup data={popdata} setdetails={setdetails} setdeleted={setdeleted}></Popup>}> </Route>
          </Route>
          </Routes>
        </BrowserRouter>
